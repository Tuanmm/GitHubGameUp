...
public static class SimplePool
{
    ...
    class Pool
    {
        ...
        public GameObject SpawnNoCreat(Vector3 pos, Quaternion rot, string name)
        {
            GameObject obj;
            if (inactive.Count == 0)
            {
    ...
    // All of our pools
    static Dictionary<string, Pool> pools;
    ...
    static public GameObject SpawnNowCreat(string name, Vector3 pos, Quaternion rot)
    {
        //Init(prefab);        
        GameObject obj = pools[name].SpawnNoCreat(pos, rot, name);
        return obj;
    }
    ...
    static public int GetInactiveCount(string name)
    {
        return pools[name].GetInactiveCount();
    }
}